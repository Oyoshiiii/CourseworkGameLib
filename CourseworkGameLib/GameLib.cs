namespace CourseworkGameLib
{
    ...
    public class Lilith : Character
    {
        ...
        public Lilith()
        {
            ...
            storyLines = new List<string>
            {
                ...
                "\tТяжело без Джилл и Джона.. надеюсь, они вернутся скоро.. Дай еще чуть времени подумать.. помню, я " +
                ...
                "\tЭто было тяжело, но вы справились.. уверена, что вы еще сможете быстро накопить опыт, " +
                "у вас все получится!",
    ...
    public class Robert : Character
    {
        ...
        public Robert()
        {
            ...
            storyLines = new List<string>
            {
                ...
                //Ответ 1 на -> Извините?. Я хоть и пару дней тут, но ничем не хуже Джилл или Джона --- 2
                ...
                " они готовы пить любое пойло, лишь бы сладко было и популярно",
                ...
                "\tЧто ж, признаю, я удивлен. Думаю, я погорячился, наговорив вам всякого.. прошу меня простить, день " +
                ...
                //Предложение нового напитка --- 11
                "\tЭто не то, что я заказывал.. но, признаться честно, мне этот напиток даже понравился больше, я не помню, " +
                "чтобы он был у нас в меню.. "
            };
        }
    }
    ...
    {
        public static string MainGameLine(int autosaveCode)
        {
            string dialog = "";
            ...
            if (autosaveCode > 16)
            {
                dialog = robert.Name + ": " + robert.StoryLines(autosaveCode - 17);
            }
            else
            {
