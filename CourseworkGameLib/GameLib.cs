    ...
    public class Peter : Character
    {
        public Peter()
        {
            ...
            storyLines = new List<string>
            {
                ...
                //Ответ 1 на -> Извините?. Я хоть и пару дней тут, но ничем не хуже Марты или Сильв
                "\tКонечно, верим, только не плачь, не горю желанием пить соленый коктейль",

                //Ответ 2 на -> Не переживайте, я приготовлю все в лучшем виде
                ...
                //Принятие заказа, если он выполнен верно
